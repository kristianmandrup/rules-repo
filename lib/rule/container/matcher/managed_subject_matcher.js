...
(function(){
  var util, flatten, Debugger, SubjectMatcher, RuleMixin, ManagedSubjectMatcher;
  util = require('../../../util');
  flatten = util.array.flatten;
  Debugger = util.Debugger;
  SubjectMatcher = require('./rule_subject_matcher');
  RuleMixin = require('../rule_mixin');
  module.exports = ManagedSubjectMatcher = (function(){
    ManagedSubjectMatcher.displayName = 'ManagedSubjectMatcher';
    var prototype = ManagedSubjectMatcher.prototype, constructor = ManagedSubjectMatcher;
    importAll$(prototype, arguments[0]);
    importAll$(prototype, arguments[1]);
    function ManagedSubjectMatcher(container, debugging){
