...
(function(){
  var utily, util, every, camelize, subjectFor, Debugger, RuleMixin, ManagedSubjectMatcher, SubjectMatcher, RuleMatcher, toString$ = {}.toString;
  utily = require('util');
  util = require('../../../util');
  ...
  module.exports = RuleMatcher = (function(){
    ...
    prototype._configure = function(){
      ...
      this.managedSubjectMatcherClass = ManagedSubjectMatcher;
      this.subjectMatcherClass = SubjectMatcher;
    ...
    prototype.managedSubjectMatcher = function(){
      return new this.managedSubjectMatcherClass(this.actContainer(), this.debugging);
    };
    ...
    prototype.subjectMatcher = function(){
      ...
      return new this.subjectMatcherClass(this.actionSubjects(), this.debugging);
    };
