...
module.exports = class RuleMatcher implements Debugger, RuleMixin
  ...
  _configure: ->
    ...
    @managed-subject-matcher-class  = ManagedSubjectMatcher
    @subject-matcher-class          = SubjectMatcher
  ...
  managed-subject-matcher: ->
    new @managed-subject-matcher-class @act-container!, @debugging
  ...
  subject-matcher: ->
    ...
    new @subject-matcher-class @action-subjects!, @debugging
